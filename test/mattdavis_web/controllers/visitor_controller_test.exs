defmodule MattdavisWeb.VisitorControllerTest do
  use MattdavisWeb.ConnCase

  alias Mattdavis.Attention

  @create_attrs %{email: "some email", name: "some name", what: "some what"}
  ...
  def fixture(:visitor) do
    {:ok, visitor} = Attention.create_visitor(@create_attrs)
    visitor
  end
